    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-16 min-h-screen">
        ...
        <div className="flex flex-col md:flex-row min-h-screen">
          ...
          <div className="md:basis-[35%] w-full flex flex-col items-center md:items-start text-center md:text-left p-8 md:p-12 bg-gray-100 space-y-6">
            <img 
              src="/assets/image/my.png" 
              alt="Profile" 
              className="w-60 h-70 rounded-xl shadow-md object-cover"
            />
          ...
          {/* Right: Name & Role (60%) */}
          <div className="md:basis-[65%] w-full flex flex-col items-center justify-center text-center p-8 md:p-12 animate-fade-in">
            <button
